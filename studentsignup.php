...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($checkResult->num_rows > 0) {
      echo '<script type ="text/JavaScript">';  
        ...
        $insertQuery = "INSERT INTO student (username, email, pass, confpass) VALUES ('$username', '$email', '$password', '$conf_password')";
...
<div class="container">
  ...
  <nav>
        <ul class="top-icons">
          <li class="back-button"><a href="stulogin.php" class="icon-link icon"><i class="fas fa-arrow-left"></i> </a></li>
          </ul>
      </nav>
