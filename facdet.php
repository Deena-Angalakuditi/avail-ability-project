...
<body>
    <div class="container">
        <h1 class="display-4 text-center">User Information</h1>
    ...
    <tbody>
                ...
                $selectQuery = "SELECT username, dept, role, status, description FROM signup WHERE username LIKE '%$searchQuery%'";
